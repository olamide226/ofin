...
func main() {
	...
	flag.IntVar(&cfg.Pack.FullN, "full-n", cfg.Pack.FullN, "sources given full text in the prompt")
	flag.IntVar(&cfg.Pack.FullChars, "full-chars", cfg.Pack.FullChars, "char cap for full-text sources")
	flag.IntVar(&cfg.Pack.TailChars, "tail-chars", cfg.Pack.TailChars, "char cap for tail sources (0 = summary only)")
